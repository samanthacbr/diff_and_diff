...
author: "Samantha Cerrvantes, Luis Fierro, Coral Hernández, Alfredo Lefranc, Marco Ramos"
date: "abril 2021"
output:
...
Nota: En adelante, los títulos quedaron muy grandes (hay que agregarles uno o dos "#")
...
--
$$IPV_{ist} = \gamma_s+ \delta (\text{Reform}_st) + X_{ist}\beta +\alpha_{s} +\miu_{t} + \epsilon_{ist} $$
...
$\miu_{t}$ es el vector de EF de tiempo de la encuesta
...
#####helppp no sé hacer el in line de esta
...
Problema: solo dos observaciones para el período de largo plazo
